...
//  DesignCode
//
//  Created by Жаслан Танербергенов on 01.11.2022.
//
...
struct PlayView: View {
    var body: some View {
        PlayShape()
            ...
            .background(
                PlayShape().fill(.angularGradient(colors: [.blue, .red, .blue], center: .center, startAngle: .degrees(0), endAngle: .degrees(360)))
                    .blur(radius: 12)
            )
            .offset(x: 2)
