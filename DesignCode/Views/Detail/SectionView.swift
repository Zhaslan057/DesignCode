...
struct SectionView: View {
    ...
    var content : some View {
        VStack(alignment: .leading, spacing: 30) {
            Text("SwiftUT is hands-down the best way for designers to take a first step into code. ")
                .font(.title).fontWeight(.medium)
            Text("This course")
                .font(.title).bold()
            Text("This course is unlike any other. We care about design and want to make sure that you get better at it in the process. It was written for designers and developers who are passionate about collaborating and building real apps for iOS and macOS. While it's not one codebase for all apps, you learn once and can apply the techniques and controls to all platforms with incredible quality, consistency and performance. It's beginner-friendly, but it's also packed with design tricks and efficient workflows for building great user interfaces and interactions.")
            Text("This year, SwiftUI got major upgrades from the WWDC 2020. The big news is that thanks to Apple silicon, Macs will be able to run 10S and iPad apps soon. Swiftul is the only framework that allows you to build apps for all of Apple's five platforms: 10S, iPados, macOS, tvos and watchos with the same codebase. New features like the Sidebar, Lazy Grid, Matched Geometry Effect and Xcode 12's visual editing tools will make it easier than ever to build for multiple platforms.")
